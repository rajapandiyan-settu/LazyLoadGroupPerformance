...
let lazyLoadData = [];
createLazyLoadData(100000);
var foreignData = window.orderDataSource;
for (var i=0; i< foreignData.length; i++) {
    foreignData[i]['EmployeeID'] = i
}
let date1;
let date2;
let date3;
...
function createLazyLoadData(count) {
    ...
    for (var i = 0; i < count; i++) {
        lazyLoadData.push({
            ...
            ProductID: i,
            EmployeeID: Math.floor(Math.random() * 800) + 1
        });
    }
}
